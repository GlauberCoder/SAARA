...
// import { Operation, Transaction} from "../domain/operation";
...
//     const calc = new Moviment(55980, 100, 3, new ExchangerSymbol(new Exchanger(0.5, 0.5)));
...
//     const calc = new Moviment(100, 100, 3, new ExchangerSymbol(new Exchanger(0.5, 0.5)));
...
//     const calc = new Moviment(55990, 1200, 3, new ExchangerSymbol(new Exchanger(0.5, 0.5)));
...
//     const calc = new Moviment(55990, 100, 3, new ExchangerSymbol(new Exchanger(0.5, 0.5)));
...
//     calc.Transactions = [
//       new Transaction(new Moviment(55800,10), 10, TypesOfTransaction.buy),
//       new Transaction(new Moviment(55900,10), 10, TypesOfTransaction.buy),
//     ];
...
//     calc.Transactions= [
//       new Transaction(new Moviment(55800,10), 10, TypesOfTransaction.buy),
//       new Transaction(new Moviment(55900,20), 10, TypesOfTransaction.buy),
//     ];
...
//     const calc = new Operation();
//     calc.Transactions= [
//       new Transaction(new Moviment(55800,10), 10, TypesOfTransaction.stop),
//       new Transaction(new Moviment(55900,20), 10, TypesOfTransaction.stop),
//     ];
//     expect(calc.averageSpent()).toBe(55866.67);
//   }));
//
...
//     const calc = new Operation();
//     calc.Transactions= [
//       new Transaction(new Moviment(55800,20), 70, TypesOfTransaction.buy),
//       new Transaction(new Moviment(55900,20), 100, TypesOfTransaction.buy),
//
//     ];
...
//     const calc = new Operation();
//     calc.Transactions= [
//       new Transaction(new Moviment(55800,100,70), 70, TypesOfTransaction.buy),
//       new Transaction(new Moviment(55900,100,70), 100, TypesOfTransaction.buy),
//       new Transaction(new Moviment(55700,100,70), 30, TypesOfTransaction.stop),
//       new Transaction(new Moviment(55300,100,70), 100, TypesOfTransaction.stop),
//     ];
