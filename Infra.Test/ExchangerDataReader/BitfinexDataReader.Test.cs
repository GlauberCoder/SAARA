...
namespace Infra.Test
{
	public class BitfinexDataReaderTest
	{
		...
		[
			...
			InlineData("BTCUSD", CandleTimespan.OneMinute, "https://api.bitfinex.com/v2/candles/trade:1m:tBTCUSD/last"),
			InlineData("BTCUSD", CandleTimespan.FiveMinutes, "https://api.bitfinex.com/v2/candles/trade:5m:tBTCUSD/last"),
			InlineData("BTCUSD", CandleTimespan.FifteenMinutes, "https://api.bitfinex.com/v2/candles/trade:15m:tBTCUSD/last"),
			InlineData("BTCUSD", CandleTimespan.ThirtyMinutes, "https://api.bitfinex.com/v2/candles/trade:30m:tBTCUSD/last"),
			InlineData("BTCUSD", CandleTimespan.OneHour, "https://api.bitfinex.com/v2/candles/trade:1h:tBTCUSD/last"),
			InlineData("ETHUSD", CandleTimespan.OneMinute, "https://api.bitfinex.com/v2/candles/trade:1m:tETHUSD/last")
		]
		public void The_Bitfinex_URL_Should_Be(string symbolName, CandleTimespan timespan, string expected)
		{
			var actual = new BitfinexDataReader().GetUrlFrom(new Symbol() { Name = symbolName }, timespan);
